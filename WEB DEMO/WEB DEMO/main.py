...
from wtforms import StringField, SubmitField, PasswordField, FileField, IntegerField, SelectField, RadioField, FloatField
...
policy = Policy(
    id=18,
    image="images/hdfcergo.jpg",
    name="HDFC Ergo",
    cover="Rs.35,040",
    monthly="Rs.696",
    yearly="Rs.1,850 ",
    type="Bike",
    features="Plan will cover you and your vehicle against number of risks arising out of destruction done to the vehicle due to an accident, theft etc." 
   " It also covers death of driver and/or passengers inside the vehicle in the event of an accident.",





    claim="This cover is mandated by IRDAI, it is compulsory for Owner-Driver to possess a PA cover of minimum Rs 15 Lacs, except in certain conditions."
"By not choosing this cover, you confirm that you hold an existing PA cover or you do not possess a valid driving license."
